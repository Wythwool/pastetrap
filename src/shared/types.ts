...
export type CommandSource = 'code-block' | 'inline' | 'copy-neighbor' | 'clipboard-payload' | 'attribute';
export type ScanSource = 'initial' | 'mutation' | 'route' | 'popup-action' | 'clipboard';
...
export type TrustScope = 'host' | 'path';

export interface TrustedSiteRule {
  id: string;
  host: string;
  pathPrefix: string;
